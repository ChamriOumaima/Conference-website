...
if (file_exists('form1.xml')) {
    ...
    $root = $dom->getElementsByTagName("register")->item(0);
     ...
     $participant_node = participant($dom,$participant_num+1, $sexe, $withpaper, $nom, $prenom,$email, $email2, $paye, $devise, $montant, $author_list, $affiliation_list, $city , $country , $address ,$date, $hour , $arrivalDate , $arrivalHour , $arrivalAirport , $departureDate , $departureHour , $departureAirport , $numPaper, $titlePaper ,$hotelName , $hotelAddress , $hotelTel , $seParticipate , $seDevise , $seMontant ,$accompagned , $prentship , $accName);
...
/////////////////////////////////////////////////////////////////////////////
  ...
  header('Location: index.html');
    ...
    $participant_node = participant($dom,1, $sexe, $withpaper, $nom, $prenom,$email, $email2, $paye, $devise, $montant, $author_list, $affiliation_list, $city , $country , $address ,$date, $hour , $arrivalDate , $arrivalHour , $arrivalAirport , $departureDate , $departureHour , $departureAirport , $numPaper, $titlePaper ,$hotelName , $hotelAddress , $hotelTel , $seParticipate , $seDevise , $seMontant ,$accompagned , $prentship , $accName);
